...
//                                   'Phone Number',
//                                   'Enter phone number (e.g., +911234567890)',
//                                   labelFontSize,
//                                   constraints,
...
//                 ? controller.text
//                 : dropdownItems.first, // Default to the first item ("Male")
...
// //   }
// //
// //   // Submit data to the next screen
// //   // Update the _submitData method in _SignupPageState class
// //   void _submitData() {
...
//     if (!_formKey.currentState!.validate()) return;
//
//     final hasAadhaarDetails = _isAadhaarComplete();
//     final hasVoterDetails = _isVoterComplete();
//
//     // Check if at least one set of documents is complete
//     if (!(hasAadhaarDetails || hasVoterDetails)) {
//       _showErrorSnackBar(
//           'Please provide either complete Aadhaar details or complete Voter ID details.');
//       return;
//     }
//
...
//     final documentsData =
//         _createDocumentsPayload(hasAadhaarDetails, hasVoterDetails);
//
//     // Create files list for passing to screens
//     final List<String> files = [];
//
//     // Add files based on which documents were provided
//     if (hasAadhaarDetails) {
//       files.add(_aadhaarFront!.path);
//       files.add(_aadhaarBack!.path);
//     }
//     if (hasVoterDetails) {
//       files.add(_voterFront!.path);
//       files.add(_voterBack!.path);
//     }
//
//     if (_isYesSelected) {
//       // Navigate to QualificationScreen with files
//       Navigator.push(
//         context,
//         MaterialPageRoute(
//           builder: (context) => QualificationScreen(
...
//             qualificationData: widget.qualificationData,
//             documentsData: documentsData,
//             files: [], // Pass the files list
//           ),
//         ),
//       );
//     } else {
//       // Navigate to PasswordPage with files
//       Navigator.push(
//         context,
//         MaterialPageRoute(
//           builder: (context) => PasswordPage(
...
//             state: widget.addressData['state'] ?? '',
//             pincode: widget.addressData['pincode'] ?? '',
//             profession: widget.qualificationData['profession'] ?? '',
//             qualification: widget.qualificationData['qualification'] ?? '',
//             position: widget.qualificationData['position'] ?? '',
//             aadhaarNumber: documentsData['aadhaarNumber'] ?? '',
//             voterId: documentsData['voterId'] ?? '',
//             aadhaarBack: documentsData['aadhaarBackFile'] ?? '',
//             aadhaarFront: documentsData['aadhaarFrontFile'] ?? '',
...
//
// // Validation helpers
//   bool _isAadhaarComplete() {
//     return _aadhaarIDController.text.isNotEmpty &&
//         _aadhaarBack != null &&
//         _aadhaarFront != null;
//   }
//
//   bool _isVoterComplete() {
//     return _voterIDController.text.isNotEmpty &&
//         _voterFront != null &&
//         _voterBack != null;
//   }
//
// // Create documents payload based on what was filled
//   Map<String, String> _createDocumentsPayload(bool hasAadhaar, bool hasVoter) {
//     final documentsData = <String, String>{};
//
//     // Case 1: Only Aadhaar
//     if (hasAadhaar && !hasVoter) {
//       documentsData['aadhaarNumber'] = _aadhaarIDController.text;
//       documentsData['aadhaarBackFile'] = _aadhaarBack!.path;
//       documentsData['aadhaarFrontFile'] = _aadhaarFront!.path;
//     }
//     // Case 2: Only Voter
//     else if (!hasAadhaar && hasVoter) {
//       documentsData['voterId'] = _voterIDController.text;
//       documentsData['voterFrontFile'] = _voterFront!.path;
//       documentsData['voterBackFile'] = _voterBack!.path;
//     }
//     // Case 3: Both Aadhaar and Voter
//     else if (hasAadhaar && hasVoter) {
//       documentsData['aadhaarNumber'] = _aadhaarIDController.text;
//       documentsData['aadhaarBackFile'] = _aadhaarBack!.path;
//       documentsData['aadhaarFrontFile'] = _aadhaarFront!.path;
...
//   }
//
// // Handle navigation based on Yes/No selection
//   void _handleNavigation(Map<String, String> documentsData) {
//     if (_isYesSelected) {
//       // Case: Yes selected - Go to QualificationScreen
//       Navigator.push(
//         context,
//         MaterialPageRoute(
//           builder: (context) => QualificationScreen(
...
//       );
//     } else {
//       // Case: No selected - Go directly to PasswordPage
//       Navigator.push(
//         context,
//         MaterialPageRoute(
//           builder: (context) => PasswordPage(
...
//             pincode: widget.addressData['pincode'] ?? '',
//
//             // No qualification data for "No" selection
//             profession: widget.qualificationData['profession'] ?? '',
//             qualification: widget.qualificationData['qualification'] ?? '',
//             position: widget.qualificationData['position'] ?? '',
//
//             // Only include document data that was actually provided
//             // Document data
//             aadhaarNumber: documentsData['aadhaarNumber'] ?? '',
//             voterId: documentsData['voterId'] ?? '',
//             aadhaarBack: documentsData['aadhaarBackFile'] ?? '',
...
//               contentPadding: const EdgeInsets.all(12.0),
//             ),
//             keyboardType: label.contains('Aadhaar')
...
//       try {
//         final filesMap = {
//           'aadhaarBack': widget.aadhaarBack,
//           'aadhaarFront': widget.aadhaarFront,
//           'voterFront': widget.voterFront,
//           'voterBack': widget.voterBack,
//         };
//
...
//                         _talukaController,
//                       ),
//                       SizedBox(height: 8), // Space between the fields
//                       _buildFormField(
//                         "District",
//                         "Enter district",
//                         _districtController,
...
// //     }
// //
// //     // If both Aadhaar and Voter details are filled, include both in the payload
// //     if (hasAadhaarDetails && hasVoterDetails) {
// //       _submitPayload(true, true);
// //     } else if (hasAadhaarDetails) {
// //       // If only Aadhaar details are filled, include only Aadhaar in the payload
// //       _submitPayload(true, false);
// //     } else if (hasVoterDetails) {
// //       // If only Voter details are filled, include only Voter in the payload
// //       _submitPayload(false, true);
// //     }
// //   }
// //
// // // Method to handle submission payload
// //   void _submitPayload(bool hasAadhaar, bool hasVoter) {
// //     final documentsData = <String, String>{};
// //
// //     if (hasAadhaar) {
// //       // Only include Aadhaar details in the payload if they are provided
// //       documentsData['aadhaarNumber'] = _aadhaarIDController.text ?? '';
// //       documentsData['aadhaarBackFile'] = _aadhaarBack?.path ?? '';
// //       documentsData['aadhaarFrontFile'] = _aadhaarFront?.path ?? '';
// //     }
// //
// //     if (hasVoter) {
// //       // Only include Voter details in the payload if they are provided
// //       documentsData['voterId'] = _voterIDController.text ?? '';
// //       documentsData['voterFrontFile'] = _voterFront?.path ?? '';
// //       documentsData['voterBackFile'] = _voterBack?.path ?? '';
// //     }
// //
// //     // Navigate based on the selection of community service (Yes/No)
// //     if (_isYesSelected) {
// //       // If Yes is selected, proceed to QualificationScreen to collect qualification data
// //       Navigator.push(
// //         context,
...
// //             pincode: widget.addressData['pincode'] ?? '',
// //
// //             // Set qualification fields to null for "No" selection
// //             profession: "null",
// //             qualification: "null",
// //             position: "null",
// //
...
// //             voterBack: documentsData['voterBackFile'] ?? '',
// //
// //             // Files (not used in "No" case, so empty list)
// //             files: [],
// //           ),
// //         ),
// //       );
...
// //       documentsData['aadhaarFrontFile'] = _aadhaarFront?.path ?? '';
// //     } else {
// //       // Set Aadhaar data to null if not provided
// //       documentsData['aadhaarNumber'] = 'null';
// //       documentsData['aadhaarBackFile'] = 'null';
// //       documentsData['aadhaarFrontFile'] = 'null';
// //     }
// //
// //     if (hasVoter) {
// //       // Only include Voter details in the payload if they are provided
...
// //       documentsData['voterBackFile'] = _voterBack?.path ?? '';
// //     } else {
// //       // Set Voter data to null if not provided
// //       documentsData['voterId'] = 'null';
// //       documentsData['voterFrontFile'] = 'null';
// //       documentsData['voterBackFile'] = 'null';
// //     }
// //
// //     // Navigate based on the selection of community service (Yes/No)
// //     if (_isYesSelected) {
...
//     final documentsData =
//         _createDocumentsPayload(hasAadhaarDetails, hasVoterDetails);
//     _handleNavigation(documentsData);
//   }
//
// // Validation helpers
//   bool _isAadhaarComplete() {
...
//       String hint,
//       TextEditingController controller,
//       bool isNumeric, // Add this parameter to decide the input type
//       ) {
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
...
//               contentPadding: const EdgeInsets.all(12.0),
//             ),
//             keyboardType: isNumeric ? TextInputType.number : TextInputType.text, // Conditionally set the keyboard type
//           ),
//         ),
//       ],
//     );
...
class _AddressFormScreen extends State<AddressFormScreen> {
  ...
  Widget _buildFormField(
    ...
    List<TextInputFormatter>? inputFormatters,
    String? Function(String?)? validator,
    bool restrictToSixCharacters =
        false, // Added parameter for character restriction
  }) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        Container(
          ...
          child: TextFormField(
            ...
            onChanged: restrictToSixCharacters
                ? (value) {
                    if (value.length > 6) {
                      controller.text = value.substring(0, 6);
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      _buildFormField(
                        ...
                        restrictToSixCharacters:
                            true, // Restrict input to 6 characters
                      ),
                    ],
                  ),
                  SizedBox(height: 25),
...
class _PasswordPageState extends State<PasswordPage> {
  ...
  //         await prefs.setString('middleName', widget.middleName);
  //         await prefs.setString('lastName', widget.lastName);
  //         await prefs.setString('dateOfBirth', widget.dateOfBirth);
    ...
    if (_formKey.currentState!.validate()) {
      try {
        ...
        if (response.statusCode == 201) {
          ...
          await prefs.setString('age', widget.age);
          await prefs.setString('gender', widget.gender);
          await prefs.setString('addressLine1', widget.addressLine1);
          await prefs.setString('addressLine2', widget.addressLine2);
          await prefs.setString('city', widget.cityOrVillage);
          await prefs.setString('state', widget.state);
          await prefs.setString('pinCode', widget.pincode);

          await prefs.setString('voterId', widget.voterId);
          await prefs.setString('voterFront', widget.voterFront);
          await prefs.setString('voterBack', widget.voterBack);
          await prefs.setString('aadhaarNumber', widget.aadhaarNumber);
          await prefs.setString('aadhaarFront', widget.aadhaarFront);
          await prefs.setString('aadhaarBack', widget.aadhaarBack);
